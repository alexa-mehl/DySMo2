...
simInfo.tolerance = 1e-06      # tolerance of solver
simInfo.intervalNum = 1000    # number of saved data
...
model.moFile = ['bounceWand.mo'] # SET: name of Modelfiles, separated by comma
...
model.arrToSave = ['x', 'h'] # SET: the names of the variables you want to save, these names will apprear in the observer date file, but the variables might be called differently in each mode
model.plotList = [['x', 'h']] # SET: data to be plotted at the end of the simulation. (t represents time), names correspond to the arrToSave names


########################################### DEFINE A MODE ###########################################
mode1 = d.mode() 

mode1.modeName = "bounceWand.ball_struc" # SET: name of the model for this mode
mode1.tool = Env.DYMOLA # SET: tool which is used for the simulation of this mode
mode1.arrToSave = ['x', 'h'] # SET: variables to be observed, these will be saved under the specified names in the model
...
trans1_2.outName = ['x', 'h', 'vx', 'vy'] # SET: variable names to read from mode1
trans1_2.inName = ['x', 'damper.s_rel', 'vx', 'damper.v_rel'] # SET: corresponding variable names to be initialized in the new mode


trans1_3 = d.trans()

trans1_3.modeIDToSw = 3
trans1_3.outName = ['x', 'vx', 'h', 'vy']
trans1_3.inName = ['damper.s_rel', 'damper.v_rel', 'h', 'v']


########  Add transitions to mode ############

mode1.transitions = [trans1_2, trans1_3] # add transistions to the mode, if more than one transition was created add them comma separated
...
mode2.modeName = "bounceWand.contact_struc"
mode2.tool = Env.DYMOLA
mode2.arrToSave = ['x', 'damper.s_rel']
...
trans2_1.outName = ['damper.s_rel', 'x', 'vx', 'damper.v_rel']
trans2_1.inName = ['h' ,'x', 'vx', 'vy']
...
mode3.modeName = "bounceWand.contact_wall"
...
trans3_1.modeIDToSw = 1
trans3_1.outName = ['damper.s_rel','damper.v_rel', 'h', 'v']
trans3_1.inName = ['x' ,'vx', 'h', 'vy']
