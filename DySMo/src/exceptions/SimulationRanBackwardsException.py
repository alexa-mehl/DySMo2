...
class SimulationRanBackwardsException(SimulationFailedException):
	#Constructor
	def __init__(this):
		SimulationFailedException.__init__(this);
		
	#Magic methods
	def __str__(this):
		return "Simulation ended before it started (endTime < startTime).";